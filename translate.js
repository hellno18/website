...
aLangKeys['en']['horror']='Horror game genre, the essence has always been fear.It was made by Unreal Engine and also substance material. The purpose of this game is find a key to get out from haunted house.';
aLangKeys['en']['webPortfolio']='This portfolio website was created for showcase my works. The source code of this website hosted directly in GitHub repository.';
aLangKeys['en']['fruit']='This personal project was created by Unity. The genre concept is puzzle game. This game use assets from the assets store in my game.';
aLangKeys['en']['pinatata']='This group project was created by Unity. When GameJam, our team would make a simple and fun game within 2 days. My roles is make a UI/UX Design. The repository manager used Git.';
aLangKeys['en']['projects']='Projects';
aLangKeys['en']['sub-projects']='I started my personal projects in 2018 as student in Japan. My personal works are using Unity Game Engine. And also, The below link will direct you to view source code on GitHub.';
aLangKeys['en']['dialog1']='This game was created by Unity Engine,The purpose is to learn and play the basis for a solid First Person Shooter.';
aLangKeys['en']['dialog2']='2D Puzzle Game, inspired by Disney Tsum Tsum. So I make a simple game and fun.';
aLangKeys['en']['button']='View On GitHub';


//japanese
aLangKeys['jp']['home']='ホーム';
aLangKeys['jp']['about']='自己紹介';
aLangKeys['jp']['portfolio']='ポートフォリオ';
...
aLangKeys['jp']['horror']='ホラーゲームのジャンル、その本質は常に恐れられてきました。それはUnreal Engineによって作られた。 このゲームの目的は、お化け屋敷から出るための鍵を見つけることです。'
aLangKeys['jp']['webPortfolio']='このポートフォリオのサイトは私の作品を紹介するために作成されました。 このサイトのコードは「GIT」リポジトリに直接ホストされています。';
aLangKeys['jp']['fruit']='個人的なプロジェクトでUnityを作成されました。 ジャンルのコンセプトはパズルゲームです。 このゲームのUIはアセットストアからのアセットを使用します。';
aLangKeys['jp']['pinatata']='グループプロジェクトでUnityを作成されました。 ゲームジャムのとき、私たちのチームは2日以内にシンプルで楽しいゲームを作ると考えました。 私の管理はUI / UXデザインを作ることです。 リポジトリマネージャはGitを使用しました。';
aLangKeys['jp']['projects']='作品について';
aLangKeys['jp']['sub-projects']='学生時代はゲームを制作し、Unityゲームを使用しました。以下ボタンを押すとGITHUBウェブサイトに移動するになります。';
aLangKeys['jp']['dialog1']='このゲームはUnityゲームエンジンを使用して、目的は初心者の方が楽しみプレイすることです';
aLangKeys['jp']['dialog2']='ディズニーツムツムから触発されて２Dパズルゲームを制作しました。楽しみだけでなくシンプルなゲームを作て誰でも遊ぶことができるの目標です。';
aLangKeys['jp']['button']='ソースコードを表示';
